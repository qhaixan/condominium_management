            ...
            <x-slot name="body">
                <div x-data="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <!-- <input type="text"  name="unit_block" class="form-control" placeholder="{{ __('Unit Block') }}" value="{{ old('unit_block') ?? $visitor->unit->unit_block }}" maxlength="100" required /> -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <!-- <input type="text"  name="unit_number" class="form-control" placeholder="{{ __('Unit Number') }}" value="{{ old('unit_number') ?? $visitor->unit->unit_number }}" maxlength="100" required /> -->
